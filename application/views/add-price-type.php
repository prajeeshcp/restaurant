	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="fa fa-table fa-fw "></i> 
				System 
			<span>> 
				<?=(empty($get_data)) ? 'Add Price Type' : 'Edit Price Type'?>
			</span>
		</h1>
		...
		<article class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false"	data-widget-editbutton="false">
				...
				<header>
					...
					<h2><?=(empty($get_data)) ? 'Add Price Type ' : 'Edit '.$get_data['type_name']?></h2>				
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="<?=site_url('manage/submit_price_type')?>" method="post" class="smart-form">
							...
							<fieldset>					
								<section>
									...
									<label class="input state-success">
										<input type="text" value="<?=(!empty($get_data)) ? $get_data['type_name'] : '' ?>" name="price_type" required>
									</label>
