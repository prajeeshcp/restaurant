		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
				...
				<header>
					...
					<h2>Menus</h2>
			<a href="<?=site_url('manage/add_menu')?>" class="btn btn-success btn-sm pull-right">Add new menu</a>
				</header>
						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									...
									<td>
										<label class="input">
											<input type="text" name="search_browser" value="Filter menu" class="search_init">
										</label>	
									</td>
                                    <td>
										<label class="input">
							...
							?>
								<tr class="odd gradeX">
									<td><?=$key+1?></td>
									<td><?=stripslashes($menu['menu_name'])?></td>
                                    <td><?=stripslashes($menu['entity_name'])?></td>
