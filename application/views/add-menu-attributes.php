							...
							<fieldset>					
								<section>
									...
									<label class="input state-success">
										<input type="text" value="<?=$attribute_name?>" name="attribute_name" required>
									</label>
								...
								<section>
									...
									<label class="select state-success">
										<select id="" name="attribute_status" required>
											<option <?=($attribute_name == 1) ? 'selected' : ''?> value="1">Enabled</option>
											<option <?=($attribute_name == 2) ? 'selected' : ''?> value="2">Disabled</option>
										</select>
										<i></i>
									</label>
