<?php $this->load->view('includes/header'); ?>
		...
		<?php $this->load->view('includes/sidebar', array('selected' => 'tablecategory')); ?>
		<!-- END NAVIGATION -->
		...
		<article class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false"	data-widget-editbutton="false">
				...
				<header>
					...
					<h2><?=(empty($get_data)) ? 'Add New Category ' : 'Edit '.$get_data['name']?></h2>				
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="<?=site_url('manage/submit_table_category')?>" method="post" class="smart-form">
							...
							<fieldset>					
								<section>
									...
									<label class="input state-success">
										<input type="text" value="<?=(!empty($get_data)) ? $get_data['name'] : '' ?>" name="category_name" required>
									</label>
