<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
  ...
  <tbody>
    <?php if (!empty($report_details)) {     	
		...
		foreach ($report_details['parcel_order_report'] as $key => $report) {
										
										
	?>
    <tr class="odd gradeX">
      <td><?=$report['datetime']?></td>
      <td><?=$report['parcel_order_count']?></td>
      <td><?=$report['grand_total_parcel_order']?></td>

      <?php 
      foreach ($report_details['parcel_order_not_paid'] as $not_paid) {
    ...
    <tr class="even gradeY">
        <th>Total</th>
        <th><?=$total_parcel_order->parcel_order_count?></th>
        <th><?=$total_parcel_order->grand_total_parcel_order?></th>
        <th><?=$count?></th>
    </tr>
  </tbody>
</table>
