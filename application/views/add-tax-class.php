	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="fa fa-table fa-fw "></i> 
				System 
			<span>> 
				<?=(empty($get_data)) ? 'Add Tax Class' : 'Edit Tax Class'?>
			</span>
		</h1>
		...
		<article class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false"	data-widget-editbutton="false">
				...
				<header>
					...
					<h2><?=(empty($get_data)) ? 'Add Tax Class ' : 'Edit '.$get_data['tax_class']?></h2>				
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="<?=site_url('manage/submit_tax_class')?>" method="post" class="smart-form">
                        <?php if (!empty($get_data)) { ?>
                        <input type="hidden" name="edit_id" value="<?=$get_data['entity_id']?>" />
                        <?php } ?>
							<fieldset>					
								<section>
									<label class="label">Tax Class Name</label>
									<label class="input state-success">
										<input type="text" value="<?=(!empty($get_data)) ? $get_data['tax_class'] : '' ?>" name="tax_class" required>
									</label>
                                ...
                                <section>
									...
									<label class="input state-success">
										<input type="text" value="<?=(!empty($get_data)) ? $get_data['tax_rate'] : '' ?>" name="tax_rate" required>
									</label>
									<div class="note note-success">This is a required field.</div>
								</section>
								<section>
